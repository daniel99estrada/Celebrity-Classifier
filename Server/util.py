...
def get_cv2_image_from_base64_string(b64str):
    ...
    '''
    if ',' not in b64str:
        raise ValueError("Invalid base64 string: does not contain a comma separator.")
    
    try:
        encoded_data = b64str.split(',')[1]
    except IndexError:
        raise ValueError("Invalid base64 string: does not contain valid base64 data.")
